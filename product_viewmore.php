                        ...
                        <tbody>
                            ...
                            //include('db_conn.php');
                               // $sql="select * from tbl_volunteers inner join tbl_area on tbl_volunteers.area_id=tbl_area.area_id;";
                                ...
                                {
                                  $id = $_GET["selectid"];
                                 $sql="select * from tbl_products inner join tbl_subcategory on tbl_products.subcat_id=tbl_subcategory.subcat_id where product_id = $id ;";
                                 ...
                                 while($row = mysqli_fetch_assoc($result))
                                 {
                                    ...
                                    ?>
                                     <tr>
                                      ...
                                      <td> <img src= "<?php echo 'uploads/product_img/'.$row["img2"]?>" height="80px" width="80px" /> </td>
                                      <td> <img src= "<?php echo 'uploads/product_img/'.$row["img3"]?>" height="80px" width="80px" /> </td>
