                ...
                <div class="col-sm-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <select class="form-control" name="state_id">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" name="city_name" type="text" placeholder="Enter City">
                        </div>
                        <?php 
                      If(isset($_POST["btn_add"]))
                      {
                        $nm = $_POST["city_name"];
                        $id = $_POST["state_id"];
                        $sql= "select * from tbl_city where  city_name='$nm' and state_id='$id';";
                        $r = mysqli_query($conn, $sql);
                        if(!empty($nm) && !empty($id) && mysqli_num_rows($r)==0){
                          $sql = "insert into tbl_city(city_name,state_id) values('$nm','$id');";
                          $result = mysqli_query($conn,$sql) or die (mysqli_error($conn));
                          ?>
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" name="btn_add">Add City</button>
