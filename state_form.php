                ...
                <div class="col-sm-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form class="theme-form" method="post" id="_frm">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" name="state_name" type="text" placeholder="Enter State">
                        </div>
                        <?php 
                      If(isset($_POST["btn_add"]))
                      {
                          ...
                          $sql= "select * from tbl_state where state_name = '$nm';";
                          $result = mysqli_query($conn,$sql) or die (mysqli_error($conn));
                          $row = mysqli_num_rows($result);
                          if($row==0)
                          {
                            $sql = "insert into tbl_state(state_name) values('$nm');";
                            $result = mysqli_query($conn,$sql) or die (mysqli_error($conn));
                    ...
                    <div class="card-footer">
                      ...
                      <button type="submit" class="btn btn-primary" name="btn_add">Add State</button>
