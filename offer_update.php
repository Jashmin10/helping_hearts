                      ...
                      <form class="theme-form" method="post" id="_frm">
                        ...
                        if(isset($_GET["selectid"]))
                        {
                         ...
                         while($row = mysqli_fetch_assoc($result))
                         {
                            ...
                            $max = $row["max"];
                            $dis = $row["discount"];
                            $_radioSelect = $row["is_display"];

                          ?>
                          <div class="mb-3">
                          <label class="col-form-label pt-0" for="exampleInputState">Tittle</label>
                          <input class="form-control" name="tittle" type="text" placeholder="Update Tittle" value="<?php echo $tt; ?>">
                        </div>
                        <div class="mb-3">
                          <label class="col-form-label pt-0" for="exampleInputState">Minimun</label>
                          <input class="form-control" name="min" type="number" placeholder="Minimum" value="<?php echo $min; ?>">
                        </div>
                        <div class="mb-3">
                          <label class="col-form-label pt-0" for="exampleInputState">Maximum</label>
                          <input class="form-control" name="max" type="number" placeholder="Maximum" value="<?php echo $max; ?>">
                        </div>
                        <div class="mb-3">
                          <label class="col-form-label pt-0" for="exampleInputState">Discount</label>
                          <input class="form-control" name="disc" type="number" placeholder="Discount" value="<?php echo $dis; ?>">
                        </div>
                  ...
                  <label class="col-sm-3 col-form-label" for="inputName3">Is_Active</label>
                        ...
                        if($_radioSelect=="yes")
                        {
                          ...
                          <div class="radio-primary">
                           ...
                           <input type="radio" name="is_display" value="yes" checked >
                           <label>Yes</label>
                         </div>
                         <div class="radio-primary">
                    ...
                    <?php    }
                         ...
                         <div class="radio-primary">
                           <input type="radio" name="is_display" value="no"  checked>
                           <label>No</label>
                         </div>
                     <?php   } ?>
                        </div>
